...
LOCAL_PROGRAM_INFO: dict[str, Any] = {
    ...
    "holopazaakDownloadLink": "https://github.com/OpenKotOR/PyKotor/releases",
    "holopazaakBetaDownloadLink": "https://github.com/OpenKotOR/PyKotor/releases/tag/v{tag}-holopazaak",
